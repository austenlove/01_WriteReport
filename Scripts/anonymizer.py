...
def anonymize_text(text, manager):
    ...
    def replace_name(match):
        ...
        return match.group(0).replace(original_name, masked)
    text = NAME_CONTEXT_PATTERN.sub( replace_name, text )
        ...
        try:
            ...
            for element in tree.iter():
                ...
                if original_text != replaced_text:
                    print(f"텍스트 치환: "f"[{original_text}] → [{replaced_text}]")
...
if __name__ == "__main__":
    input_file = Path("C:/Users/dhkim/OneDrive/문서/UiPath/전북군산교육청/Data/Input/사안조사보고서_sample.hwpx")
    output_file = Path("C:/Users/dhkim/OneDrive/문서/UiPath/전북군산교육청/Data/Output/사안조사보고서_sample.hwpx")
    mapping_file = Path("C:/Users/dhkim/OneDrive/문서/UiPath/전북군산교육청/Data/Output/사안조사보고서_sample_mapping.json")
